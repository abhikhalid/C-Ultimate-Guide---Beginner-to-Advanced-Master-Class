...
namespace CustomCollections
{
    ...
    public class Customer : IEquatable<Customer>
    {
        ...
        {
           return this.CustomerID == other.CustomerID && this.CustomerName == other.CustomerName && this.Email == other.Email 
    ...
    public class CustomersList : IList<Customer>
    {
        ...
        {
            //we can add our custom logic and throw own exception
            if (index < 0)
            {
    ...
    internal class Program
    {
        static void Main()
        {
            ...
            //Contains
            Console.WriteLine("\nContains: " + customersList.Contains(cust)); // true
            Console.WriteLine("\nContains: " + customersList.Contains(anotherCust)); //false
            ...
            //IndexOf
            Console.WriteLine("IndexOf:" + customersList.IndexOf(cust));

            //Insert
            customersList.Insert(2, cust);
